...
KOSPI_CANDIDATES = [
    ...
    "009150.KS",  # 삼성전기 — AI/MLCC/FC-BGA 수혜, +1231% (2026-06-07 분석에서 누락 발견)
    "042700.KS",  # 한미반도체 — HBM 본딩 장비, AI 반도체 핵심 소부장
    "000270.KS",  # 기아 — 전기차/로보택시 수혜
]
COMPANY_NAMES = {
    ...
    "009150.KS":"삼성전기","042700.KS":"한미반도체","000270.KS":"기아",
}
