...
**생성일시**: 2026-06-24 04:34
**분석 기간**: 2025-06-24 ~ 2026-06-24 (1년 (365일))
...
|------|------|---------|---------|--------|------|
| # 1 | HY_SPREAD              |  -0.631* |  -0.150* |   0.278 |     diff |
| # 2 | INSTITUTION_NET        |  +0.109* |  +0.400* |   0.265 | weekly_flow |
| # 4 | DXY                    |  -0.319* |  -0.192* |   0.251 |     diff |
| # 5 | WTI                    |  -0.350* |  -0.148* |   0.248 |     diff |
| # 6 | VIX                    |  -0.217* |  -0.096  |   0.242 |    level |
| # 7 | US10Y                  |  -0.237* |  -0.007  |   0.241 |     diff |
| # 8 | MARKET_STRENGTH        |  +0.217* |  +0.123* |   0.234 |    level |
| # 9 | FOREIGN_NET            |  +0.071  |  +0.290* |   0.229 | weekly_flow |
| #10 | CNN_FG                 |  +0.039  |  +0.048  |   0.199 |    level |
| #16 | BBAND                  |  +0.371* |  +0.154* |   0.052 |    level |
| #18 | STOCH_RSI              |  +0.291* |  +0.139* |   0.043 |    level |
| #19 | MARKET_MOMENTUM        |  +0.237* |  +0.140* |   0.038 |    level |
| #22 | T10Y2Y                 |  -0.074  |  -0.112* |   0.011 |     diff |
...
|------|------|--------|------|---------|---------|------|
| #1 | Alphabet Inc. (Class C) | +106.9% [주의] |   250일 | 1.2226 | 0.0000 | 1.30 |
| #2 | Nvidia       | +35.4% [주의] |   250일 | 0.8331 | 0.0000 | 1.86 |
| #3 | Apple Inc.   | +47.5% [주의] |   250일 | 0.6933 | 0.0000 | 0.90 |
| #4 | Micron Technology | +724.2% [주의] |   250일 | 0.6014 | 0.0000 | 3.13 |
| #5 | Advanced Micro Devices | +275.5% [주의] |   250일 | 0.3512 | 0.0000 | 2.90 |
...
|------|------|-----------|------|---------|---------|
| #1 | Sandisk      | +4027.0% [주의] |   250일 | 19.4613 | 0.0000 |
| #2 | Western Digital | +962.7% [주의] |   250일 | 4.8921 | 0.0000 |
| #3 | Micron Technology | +703.3% [주의] |   250일 | 3.7949 | 0.0000 |
| #4 | Lumentum     | +780.9% [주의] |   250일 | 2.9818 | 0.0000 |
| #5 | Seagate Technology | +650.9% [주의] |   250일 | 2.8722 | 0.0000 |
...
| 순위 | 기업 | 수익률 | 기간 | 기여점수 | p-value | 베타 |
|------|------|--------|------|---------|---------|------|
| #1 | HD현대일렉트릭     | +91.1% [주의] |   244일 | 0.0140 | 0.0000 | 0.98 |
| #2 | DB하이텍        | +210.2% [주의] |   244일 | 0.0139 | 0.0000 | 1.06 |
| #3 | KB금융         | +34.7% [주의] |   244일 | 0.0071 | 0.0000 | 0.50 |
| #4 | HJ중공업        | +161.2% [주의] |   244일 | 0.0067 | 0.0000 | 0.82 |
| #5 | HD현대중공업      | +26.2% [주의] |   244일 | 0.0053 | 0.0000 | 0.60 |
...
| 순위 | 기업 | 초과수익률 | 기간 | 수혜점수 | p-value |
|------|------|-----------|------|---------|---------|
| #1 | DB하이텍        | +43.7% [주의] |   244일 | 0.2505 | 0.0000 |
| #2 | HD현대에너지솔루션   | +0.1% [주의] |   244일 | 0.0004 | 0.0000 |
...
|------|-----------------|-------|-----------|
| BBAND                  | 2026-06-23   |   255 |          1 |
| CNN_FG                 | 2026-06-24   |   400 |          0 |
| DXY                    | 2026-06-18   |   271 |          6 |
| FOREIGN_NET            | 2026-06-23   |   267 |          1 |
| HY_SPREAD              | 2026-06-22   |   289 |          2 |
| INSTITUTION_NET        | 2026-06-23   |   267 |          1 |
| MARKET_MOMENTUM        | 2026-06-23   |   255 |          1 |
| MARKET_STRENGTH        | 2026-06-23   |   260 |          1 |
| STOCH_RSI              | 2026-06-23   |   247 |          1 |
| T10Y2Y                 | 2026-06-23   |   273 |          1 |
| US10Y                  | 2026-06-22   |   272 |          2 |
| VIX                    | 2026-06-23   |   275 |          1 |
| WTI                    | 2026-06-15   |   267 |          9 |
...
> 생성 기준: 2026-06-24 04:34 | 모델: AI Analyzer v3 | 데이터: 최신 파이프라인 결과

### 현재 시장 판단: 29.2/100 — **SELL·관망 우위**
...
**HY_SPREAD (하이일드스프레드, w=0.2781)**: 신용 리스크 선행 지표. 스프레드 확대 = 자금 이탈 시그널 (r=-0.631). 400bp 이하 유지 시 안정권.

**INSTITUTION_NET (w=0.2650)**: S&P500 r=+0.109, 코스피 r=+0.400.

**DXY (달러인덱스, w=0.2511)**: 글로벌 유동성의 역지표 (r=-0.319). 달러 강세 = 신흥국 자금 이탈, 원화 약세 → 코스피 압박.
