...
**생성일시**: 2026-08-20 01:57
**분석 기간**: 2025-08-20 ~ 2026-08-20 (1년 (365일))
...
|------|------|---------|---------|--------|------|
| # 1 | HY_SPREAD              |  -0.620* |  -0.117* |   0.299 |     diff |
| # 2 | DXY                    |  -0.371* |  -0.151* |   0.294 |     diff |
| # 4 | INSTITUTION_NET        |  +0.054  |  +0.357* |   0.260 | weekly_flow |
| # 5 | US10Y                  |  -0.252* |  -0.007  |   0.240 |     diff |
| # 6 | MARKET_STRENGTH        |  +0.214* |  +0.121* |   0.234 |    level |
| # 8 | FOREIGN_NET            |  +0.046  |  +0.334* |   0.233 | weekly_flow |
| #10 | VIX                    |  -0.210* |  -0.075  |   0.221 |    level |
| #13 | BBAND                  |  +0.369* |  +0.135* |   0.050 |    level |
| #15 | STOCH_RSI              |  +0.301* |  +0.108* |   0.041 |    level |
| #16 | MARKET_MOMENTUM        |  +0.234* |  +0.125* |   0.036 |    level |
| #17 | WTI                    |  -0.346* |  -0.095  |   0.035 |     diff |
| #21 | T10Y2Y                 |  -0.095  |  -0.116* |   0.012 |     diff |
...
|------|------|--------|------|---------|---------|------|
| #1 | Alphabet Inc. (Class A) | +73.4% [주의] |   250일 | 0.9389 | 0.0000 | 1.33 |
| #2 | Nvidia       | +24.2% [주의] |   250일 | 0.6740 | 0.0000 | 1.87 |
| #3 | Micron Technology | +700.8% [주의] |   250일 | 0.5297 | 0.0000 | 3.36 |
| #4 | Apple Inc.   | +40.7% [주의] |   250일 | 0.5163 | 0.0000 | 0.75 |
| #5 | Advanced Micro Devices | +182.3% [주의] |   250일 | 0.2884 | 0.0000 | 3.15 |
...
|------|------|-----------|------|---------|---------|
| #1 | Sandisk      | +3413.0% [주의] |   250일 | 16.1136 | 0.0000 |
| #2 | Micron Technology | +680.3% [주의] |   250일 | 3.6171 | 0.0000 |
| #3 | Lumentum     | +593.6% [주의] |   250일 | 2.3455 | 0.0000 |
| #4 | Western Digital | +492.1% [주의] |   250일 | 2.3404 | 0.0000 |
| #5 | Seagate Technology | +409.4% [주의] |   250일 | 1.6746 | 0.0000 |
...
| 순위 | 기업 | 수익률 | 기간 | 기여점수 | p-value | 베타 |
|------|------|--------|------|---------|---------|------|
| #1 | HD현대일렉트릭     | +66.6% [주의] |   243일 | 0.0107 | 0.0000 | 0.95 |
| #2 | DB하이텍        | +123.0% [주의] |   243일 | 0.0090 | 0.0000 | 1.05 |
| #3 | KB금융         | +48.4% [주의] |   243일 | 0.0086 | 0.0000 | 0.34 |
| #4 | GS           | +174.0% [주의] |   243일 | 0.0082 | 0.0000 | 0.36 |
| #5 | HD현대에너지솔루션   | +204.6% [주의] |   243일 | 0.0071 | 0.0000 | 0.74 |
...
| 순위 | 기업 | 초과수익률 | 기간 | 수혜점수 | p-value |
|------|------|-----------|------|---------|---------|
| #1 | HD현대에너지솔루션   | +97.9% [주의] |   243일 | 0.3280 | 0.0000 |
| #2 | GS           | +67.3% [주의] |   243일 | 0.2425 | 0.0000 |
| #3 | DB하이텍        | +16.3% [주의] |   243일 | 0.1046 | 0.0000 |
...
|------|-----------------|-------|-----------|
| BBAND                  | 2026-08-19   |   254 |          1 |
| DXY                    | 2026-08-14   |   272 |          6 |
| FOREIGN_NET            | 2026-08-19   |   267 |          1 |
| HY_SPREAD              | 2026-08-18   |   288 |          2 |
| INSTITUTION_NET        | 2026-08-19   |   267 |          1 |
| MARKET_MOMENTUM        | 2026-08-19   |   254 |          1 |
| MARKET_STRENGTH        | 2026-08-19   |   259 |          1 |
| STOCH_RSI              | 2026-08-19   |   246 |          1 |
| T10Y2Y                 | 2026-08-19   |   275 |          1 |
| US10Y                  | 2026-08-18   |   274 |          2 |
| VIX                    | 2026-08-19   |   274 |          1 |
| WTI                    | 2026-08-18   |   273 |          2 |
...
> 생성 기준: 2026-08-20 01:57 | 모델: AI Analyzer v3 | 데이터: 최신 파이프라인 결과

### 현재 시장 판단: 49.2/100 — **HOLD·중립**
...
**HY_SPREAD (하이일드스프레드, w=0.2986)**: 신용 리스크 선행 지표. 스프레드 확대 = 자금 이탈 시그널 (r=-0.620). 400bp 이하 유지 시 안정권.

**DXY (달러인덱스, w=0.2944)**: 글로벌 유동성의 역지표 (r=-0.371). 달러 강세 = 신흥국 자금 이탈, 원화 약세 → 코스피 압박.

**INSTITUTION_NET (w=0.2602)**: S&P500 r=+0.054, 코스피 r=+0.357.
