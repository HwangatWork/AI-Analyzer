...
**생성일시**: 2026-07-29 03:48
**분석 기간**: 2025-07-29 ~ 2026-07-29 (1년 (365일))
...
|------|------|---------|---------|--------|------|
| # 1 | VIX                    |  -0.212* |  -0.078  |   0.415 |    level |
| # 2 | HY_SPREAD              |  -0.621* |  -0.135* |   0.274 |     diff |
| # 3 | INSTITUTION_NET        |  +0.100* |  +0.378* |   0.262 | weekly_flow |
| # 4 | DXY                    |  -0.371* |  -0.170* |   0.254 |     diff |
| # 5 | US10Y                  |  -0.228* |  -0.042  |   0.248 |     diff |
| # 7 | WTI                    |  -0.319* |  -0.141* |   0.242 |     diff |
| # 8 | MARKET_STRENGTH        |  +0.223* |  +0.129* |   0.235 |    level |
| #10 | FOREIGN_NET            |  +0.060  |  +0.299* |   0.228 | weekly_flow |
| #12 | CNN_FG                 |  +0.039  |  +0.046  |   0.198 |    level |
| #15 | BBAND                  |  +0.365* |  +0.156* |   0.052 |    level |
| #17 | STOCH_RSI              |  +0.310* |  +0.116* |   0.043 |    level |
| #18 | MARKET_MOMENTUM        |  +0.232* |  +0.137* |   0.037 |    level |
| #22 | T10Y2Y                 |  -0.070  |  -0.152* |   0.015 |     diff |
...
|------|------|--------|------|---------|---------|------|
| #1 | Alphabet Inc. (Class A) | +71.0% [주의] |   250일 | 0.9600 | 0.0000 | 1.40 |
| #2 | Apple Inc.   | +61.6% [주의] |   250일 | 0.8556 | 0.0000 | 0.88 |
| #3 | Micron Technology | +634.0% [주의] |   250일 | 0.4525 | 0.0000 | 3.23 |
| #4 | Nvidia       | +12.4% [주의] |   250일 | 0.3472 | 0.0000 | 1.88 |
| #5 | Microsoft    | -22.6% [주의] |   250일 | 0.3128 | 0.0000 | 0.80 |
...
|------|------|-----------|------|---------|---------|
| #1 | Sandisk      | +2436.6% [주의] |   250일 | 11.3941 | 0.0000 |
| #2 | Micron Technology | +617.5% [주의] |   250일 | 3.2340 | 0.0000 |
| #3 | Western Digital | +541.6% [주의] |   250일 | 2.6499 | 0.0000 |
| #4 | Lumentum     | +478.9% [주의] |   250일 | 1.8257 | 0.0000 |
| #5 | Seagate Technology | +376.9% [주의] |   250일 | 1.6123 | 0.0000 |
...
| 순위 | 기업 | 수익률 | 기간 | 기여점수 | p-value | 베타 |
|------|------|--------|------|---------|---------|------|
| #1 | KB금융         | +43.6% [주의] |   243일 | 0.0088 | 0.0000 | 0.41 |
| #2 | DB하이텍        | +59.3% [주의] |   243일 | 0.0042 | 0.0000 | 1.06 |
| #3 | HD현대에너지솔루션   | +113.0% [주의] |   243일 | 0.0039 | 0.0000 | 0.79 |
| #4 | GS           | +70.5% [주의] |   243일 | 0.0036 | 0.0000 | 0.39 |
| #5 | KBI동양철관      | -73.7% [주의] |   243일 | 0.0035 | 0.0000 | 0.53 |
...
| 순위 | 기업 | 초과수익률 | 기간 | 수혜점수 | p-value |
|------|------|-----------|------|---------|---------|
| #1 | HD현대에너지솔루션   | +25.6% [주의] |   243일 | 0.0838 | 0.0000 |
...
|------|-----------------|-------|-----------|
| BBAND                  | 2026-07-28   |   256 |          1 |
| CNN_FG                 | 2026-07-29   |   400 |          0 |
| DXY                    | 2026-07-24   |   272 |          5 |
| FOREIGN_NET            | 2026-07-28   |   268 |          1 |
| HY_SPREAD              | 2026-07-27   |   288 |          2 |
| INSTITUTION_NET        | 2026-07-28   |   268 |          1 |
| MARKET_MOMENTUM        | 2026-07-28   |   256 |          1 |
| MARKET_STRENGTH        | 2026-07-28   |   261 |          1 |
| STOCH_RSI              | 2026-07-28   |   248 |          1 |
| T10Y2Y                 | 2026-07-28   |   274 |          1 |
| US10Y                  | 2026-07-27   |   273 |          2 |
| VIX                    | 2026-07-28   |   276 |          1 |
| WTI                    | 2026-07-20   |   267 |          9 |
...
> 생성 기준: 2026-07-29 03:48 | 모델: AI Analyzer v3 | 데이터: 최신 파이프라인 결과

### 현재 시장 판단: 36.5/100 — **SELL·관망 우위**
...
**VIX (공포지수, w=0.4148)**: 현재 시장 변동성을 가장 정확하게 선행합니다. VIX 상승 = 주식 하락 압력 (r=-0.212). 30 초과 시 극도 공포 구간으로 역매수 기회.

**HY_SPREAD (하이일드스프레드, w=0.2738)**: 신용 리스크 선행 지표. 스프레드 확대 = 자금 이탈 시그널 (r=-0.621). 400bp 이하 유지 시 안정권.

**INSTITUTION_NET (w=0.2624)**: S&P500 r=+0.100, 코스피 r=+0.378.
