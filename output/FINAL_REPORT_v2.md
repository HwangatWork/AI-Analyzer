...
**생성일시**: 2026-07-28 03:52
**분석 기간**: 2025-07-28 ~ 2026-07-28 (1년 (365일))
...
|------|------|---------|---------|--------|------|
| # 1 | VIX                    |  -0.212* |  -0.080  |   0.415 |    level |
| # 2 | HY_SPREAD              |  -0.623* |  -0.138* |   0.274 |     diff |
| # 3 | INSTITUTION_NET        |  +0.099* |  +0.389* |   0.263 | weekly_flow |
| # 4 | DXY                    |  -0.378* |  -0.177* |   0.256 |     diff |
| # 5 | US10Y                  |  -0.233* |  -0.044  |   0.248 |     diff |
| # 6 | WTI                    |  -0.323* |  -0.145* |   0.243 |     diff |
| # 8 | MARKET_STRENGTH        |  +0.224* |  +0.123* |   0.235 |    level |
| #11 | FOREIGN_NET            |  +0.061  |  +0.275* |   0.219 | weekly_flow |
| #12 | CNN_FG                 |  +0.045  |  +0.051  |   0.198 |    level |
| #16 | BBAND                  |  +0.367* |  +0.144* |   0.051 |    level |
| #17 | STOCH_RSI              |  +0.312* |  +0.110* |   0.042 |    level |
| #18 | MARKET_MOMENTUM        |  +0.232* |  +0.134* |   0.037 |    level |
...
|------|------|--------|------|---------|---------|------|
| #1 | Alphabet Inc. (Class A) | +70.0% [주의] |   250일 | 0.9296 | 0.0000 | 1.39 |
| #2 | Apple Inc.   | +58.0% [주의] |   250일 | 0.8175 | 0.0000 | 0.88 |
| #3 | Micron Technology | +710.5% [주의] |   250일 | 0.5094 | 0.0000 | 3.24 |
| #4 | Microsoft    | -23.5% [주의] |   250일 | 0.3238 | 0.0000 | 0.80 |
| #5 | Nvidia       | +11.3% [주의] |   250일 | 0.3195 | 0.0000 | 1.88 |
...
|------|------|-----------|------|---------|---------|
| #1 | Sandisk      | +2935.4% [주의] |   250일 | 13.9029 | 0.0000 |
| #2 | Micron Technology | +694.5% [주의] |   250일 | 3.6760 | 0.0000 |
| #3 | Western Digital | +607.7% [주의] |   250일 | 2.9913 | 0.0000 |
| #4 | Lumentum     | +548.3% [주의] |   250일 | 2.1050 | 0.0000 |
| #5 | Seagate Technology | +431.5% [주의] |   250일 | 1.8662 | 0.0000 |
...
| 순위 | 기업 | 수익률 | 기간 | 기여점수 | p-value | 베타 |
|------|------|--------|------|---------|---------|------|
| #1 | KB금융         | +52.5% [주의] |   243일 | 0.0101 | 0.0000 | 0.41 |
| #2 | HD현대일렉트릭     | +46.7% [주의] |   243일 | 0.0075 | 0.0000 | 0.93 |
| #3 | DB하이텍        | +86.6% [주의] |   243일 | 0.0061 | 0.0000 | 1.07 |
| #4 | HD현대에너지솔루션   | +136.9% [주의] |   243일 | 0.0046 | 0.0000 | 0.78 |
| #5 | GS           | +76.0% [주의] |   243일 | 0.0039 | 0.0000 | 0.39 |
...
| 순위 | 기업 | 초과수익률 | 기간 | 수혜점수 | p-value |
|------|------|-----------|------|---------|---------|
| #1 | HD현대에너지솔루션   | +43.3% [주의] |   243일 | 0.1387 | 0.0000 |
...
|------|-----------------|-------|-----------|
| BBAND                  | 2026-07-27   |   256 |          1 |
| CNN_FG                 | 2026-07-28   |   400 |          0 |
| DXY                    | 2026-07-24   |   273 |          4 |
| FOREIGN_NET            | 2026-07-27   |   268 |          1 |
| HY_SPREAD              | 2026-07-24   |   288 |          4 |
| INSTITUTION_NET        | 2026-07-27   |   268 |          1 |
| MARKET_MOMENTUM        | 2026-07-27   |   256 |          1 |
| MARKET_STRENGTH        | 2026-07-27   |   261 |          1 |
| STOCH_RSI              | 2026-07-27   |   248 |          1 |
| T10Y2Y                 | 2026-07-27   |   274 |          1 |
| US10Y                  | 2026-07-24   |   273 |          4 |
| VIX                    | 2026-07-27   |   276 |          1 |
| WTI                    | 2026-07-20   |   268 |          8 |
...
> 생성 기준: 2026-07-28 03:52 | 모델: AI Analyzer v3 | 데이터: 최신 파이프라인 결과

### 현재 시장 판단: 38.6/100 — **SELL·관망 우위**
...
**VIX (공포지수, w=0.4147)**: 현재 시장 변동성을 가장 정확하게 선행합니다. VIX 상승 = 주식 하락 압력 (r=-0.212). 30 초과 시 극도 공포 구간으로 역매수 기회.

**HY_SPREAD (하이일드스프레드, w=0.2743)**: 신용 리스크 선행 지표. 스프레드 확대 = 자금 이탈 시그널 (r=-0.623). 400bp 이하 유지 시 안정권.

**INSTITUTION_NET (w=0.2629)**: S&P500 r=+0.099, 코스피 r=+0.389.
