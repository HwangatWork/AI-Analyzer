...
**생성일시**: 2026-08-12 02:46
**분석 기간**: 2025-08-12 ~ 2026-08-12 (1년 (365일))
...
|------|------|---------|---------|--------|------|
| # 1 | HY_SPREAD              |  -0.618* |  -0.116* |   0.298 |     diff |
| # 2 | DXY                    |  -0.366* |  -0.167* |   0.296 |     diff |
| # 4 | INSTITUTION_NET        |  +0.065  |  +0.363* |   0.259 | weekly_flow |
| # 5 | US10Y                  |  -0.247* |  -0.004  |   0.238 |     diff |
| # 7 | MARKET_STRENGTH        |  +0.216* |  +0.124* |   0.234 |    level |
| # 8 | FOREIGN_NET            |  +0.055  |  +0.318* |   0.231 | weekly_flow |
| #10 | VIX                    |  -0.215* |  -0.082  |   0.222 |    level |
| #11 | CNN_FG                 |  +0.025  |  +0.046  |   0.192 |    level |
| #15 | BBAND                  |  +0.369* |  +0.146* |   0.051 |    level |
| #16 | STOCH_RSI              |  +0.304* |  +0.105* |   0.041 |    level |
| #17 | MARKET_MOMENTUM        |  +0.235* |  +0.129* |   0.036 |    level |
| #19 | WTI                    |  -0.335* |  -0.089  |   0.034 |     diff |
| #22 | T10Y2Y                 |  -0.093  |  -0.139* |   0.014 |     diff |
...
|------|------|--------|------|---------|---------|------|
| #1 | Alphabet Inc. (Class A) | +69.6% [주의] |   250일 | 0.9304 | 0.0000 | 1.37 |
| #2 | Nvidia       | +18.9% [주의] |   250일 | 0.5554 | 0.0000 | 1.89 |
| #3 | Micron Technology | +581.0% [주의] |   250일 | 0.4794 | 0.0000 | 3.38 |
| #4 | Apple Inc.   | +33.3% [주의] |   250일 | 0.4272 | 0.0000 | 0.75 |
| #5 | Amazon       | +22.9% [주의] |   250일 | 0.3023 | 0.0000 | 1.48 |
...
|------|------|-----------|------|---------|---------|
| #1 | Sandisk      | +2594.3% [주의] |   250일 | 12.4226 | 0.0000 |
| #2 | Micron Technology | +561.0% [주의] |   250일 | 3.0056 | 0.0000 |
| #3 | Lumentum     | +565.9% [주의] |   250일 | 2.2976 | 0.0000 |
| #4 | Western Digital | +458.6% [주의] |   250일 | 2.2698 | 0.0000 |
| #5 | Seagate Technology | +411.8% [주의] |   250일 | 1.7506 | 0.0000 |
...
| 순위 | 기업 | 수익률 | 기간 | 기여점수 | p-value | 베타 |
|------|------|--------|------|---------|---------|------|
| #1 | HD현대일렉트릭     | +62.4% [주의] |   243일 | 0.0102 | 0.0000 | 0.96 |
| #2 | KB금융         | +46.2% [주의] |   243일 | 0.0084 | 0.0000 | 0.35 |
| #3 | DB하이텍        | +102.6% [주의] |   243일 | 0.0075 | 0.0000 | 1.06 |
| #4 | HD현대에너지솔루션   | +174.9% [주의] |   243일 | 0.0062 | 0.0000 | 0.76 |
| #5 | HD현대         | +69.9% [주의] |   243일 | 0.0059 | 0.0000 | 0.53 |
...
| 순위 | 기업 | 초과수익률 | 기간 | 수혜점수 | p-value |
|------|------|-----------|------|---------|---------|
| #1 | HD현대에너지솔루션   | +72.3% [주의] |   243일 | 0.2455 | 0.0000 |
| #2 | GS           | +12.1% [주의] |   243일 | 0.0433 | 0.0000 |
...
|------|-----------------|-------|-----------|
| BBAND                  | 2026-08-11   |   257 |          1 |
| CNN_FG                 | 2026-08-12   |   400 |          0 |
| DXY                    | 2026-08-07   |   273 |          5 |
| FOREIGN_NET            | 2026-08-11   |   268 |          1 |
| HY_SPREAD              | 2026-08-10   |   288 |          2 |
| INSTITUTION_NET        | 2026-08-11   |   268 |          1 |
| MARKET_MOMENTUM        | 2026-08-11   |   257 |          1 |
| MARKET_STRENGTH        | 2026-08-11   |   262 |          1 |
| STOCH_RSI              | 2026-08-11   |   249 |          1 |
| T10Y2Y                 | 2026-08-11   |   275 |          1 |
| US10Y                  | 2026-08-10   |   274 |          2 |
| VIX                    | 2026-08-11   |   277 |          1 |
| WTI                    | 2026-08-03   |   268 |          9 |
...
> 생성 기준: 2026-08-12 02:46 | 모델: AI Analyzer v3 | 데이터: 최신 파이프라인 결과

### 현재 시장 판단: 57.4/100 — **HOLD·중립**
...
**HY_SPREAD (하이일드스프레드, w=0.2982)**: 신용 리스크 선행 지표. 스프레드 확대 = 자금 이탈 시그널 (r=-0.618). 400bp 이하 유지 시 안정권.

**DXY (달러인덱스, w=0.2960)**: 글로벌 유동성의 역지표 (r=-0.366). 달러 강세 = 신흥국 자금 이탈, 원화 약세 → 코스피 압박.

**INSTITUTION_NET (w=0.2594)**: S&P500 r=+0.065, 코스피 r=+0.363.
