...
**생성일시**: 2026-07-07 04:34
**분석 기간**: 2025-07-07 ~ 2026-07-07 (1년 (365일))
...
| # 4 | US10Y                  |  -0.199* |  -0.020  |   0.247 |     diff |
| # 5 | WTI                    |  -0.326* |  -0.115* |   0.243 |     diff |
| # 7 | MARKET_STRENGTH        |  +0.219* |  +0.110* |   0.232 |    level |
| # 8 | FOREIGN_NET            |  +0.060  |  +0.274* |   0.226 | weekly_flow |
| # 9 | VIX                    |  -0.217* |  -0.088  |   0.222 |    level |
| #10 | CNN_FG                 |  +0.040  |  +0.053  |   0.200 |    level |
| #14 | INSTITUTION_NET        |  +0.094  |  +0.398* |   0.061 | weekly_flow |
| #16 | BBAND                  |  +0.363* |  +0.145* |   0.051 |    level |
| #18 | STOCH_RSI              |  +0.299* |  +0.110* |   0.041 |    level |
| #19 | MARKET_MOMENTUM        |  +0.229* |  +0.133* |   0.036 |    level |
| #23 | T10Y2Y                 |  -0.062  |  -0.133* |   0.013 |     diff |
...
|------|------|--------|------|---------|---------|------|
| #1 | Alphabet Inc. (Class A) | +107.9% [주의] |   250일 | 1.3035 | 0.0000 | 1.33 |
| #2 | Apple Inc.   | +49.5% [주의] |   250일 | 0.7016 | 0.0000 | 0.88 |
| #3 | Nvidia       | +23.6% [주의] |   250일 | 0.6001 | 0.0000 | 1.86 |
| #4 | Micron Technology | +722.5% [주의] |   250일 | 0.5499 | 0.0000 | 3.17 |
| #5 | Advanced Micro Devices | +309.5% [주의] |   250일 | 0.3903 | 0.0000 | 2.99 |
...
|------|------|-----------|------|---------|---------|
| #1 | Sandisk      | +3736.7% [주의] |   250일 | 17.4458 | 0.0000 |
| #2 | Western Digital | +766.8% [주의] |   250일 | 3.8204 | 0.0000 |
| #3 | Micron Technology | +701.5% [주의] |   250일 | 3.6764 | 0.0000 |
| #4 | Lumentum     | +681.9% [주의] |   250일 | 2.5902 | 0.0000 |
| #5 | Seagate Technology | +469.0% [주의] |   250일 | 2.0481 | 0.0000 |
...
| 순위 | 기업 | 수익률 | 기간 | 기여점수 | p-value | 베타 |
|------|------|--------|------|---------|---------|------|
| #1 | HD현대일렉트릭     | +101.4% [주의] |   244일 | 0.0148 | 0.0000 | 0.92 |
| #2 | DB하이텍        | +142.2% [주의] |   244일 | 0.0095 | 0.0000 | 1.05 |
| #3 | KB금융         | +48.8% [주의] |   244일 | 0.0095 | 0.0000 | 0.44 |
| #4 | HD현대중공업      | +42.8% [주의] |   244일 | 0.0074 | 0.0000 | 0.56 |
| #5 | HJ중공업        | +133.7% [주의] |   244일 | 0.0056 | 0.0000 | 0.79 |
...
| 순위 | 기업 | 초과수익률 | 기간 | 수혜점수 | p-value |
|------|------|-----------|------|---------|---------|
| #1 | HD현대에너지솔루션   | +14.5% [주의] |   244일 | 0.0419 | 0.0000 |
...
|------|-----------------|-------|-----------|
| BBAND                  | 2026-07-06   |   255 |          1 |
| CNN_FG                 | 2026-07-07   |   400 |          0 |
| DXY                    | 2026-07-02   |   272 |          5 |
| FOREIGN_NET            | 2026-07-06   |   267 |          1 |
| HY_SPREAD              | 2026-07-03   |   288 |          4 |
| INSTITUTION_NET        | 2026-07-06   |   267 |          1 |
| MARKET_MOMENTUM        | 2026-07-06   |   255 |          1 |
| MARKET_STRENGTH        | 2026-07-06   |   260 |          1 |
| STOCH_RSI              | 2026-07-06   |   247 |          1 |
| T10Y2Y                 | 2026-07-06   |   273 |          1 |
| US10Y                  | 2026-07-02   |   272 |          5 |
| VIX                    | 2026-07-06   |   275 |          1 |
| WTI                    | 2026-06-29   |   268 |          8 |
...
> 생성 기준: 2026-07-07 04:34 | 모델: AI Analyzer v3 | 데이터: 최신 파이프라인 결과

### 현재 시장 판단: 48.8/100 — **HOLD·중립**
