...
**생성일시**: 2026-08-26 01:57
**분석 기간**: 2025-08-26 ~ 2026-08-26 (1년 (365일))
...
|------|------|---------|---------|--------|------|
| # 1 | VIX                    |  -0.208* |  -0.084  |   0.412 |    level |
| # 2 | HY_SPREAD              |  -0.621* |  -0.111* |   0.300 |     diff |
| # 3 | DXY                    |  -0.376* |  -0.139* |   0.296 |     diff |
| # 5 | INSTITUTION_NET        |  +0.070  |  +0.355* |   0.261 | weekly_flow |
| # 6 | US10Y                  |  -0.243* |  +0.013  |   0.243 |     diff |
| # 8 | MARKET_STRENGTH        |  +0.208* |  +0.125* |   0.233 |    level |
| # 9 | FOREIGN_NET            |  +0.053  |  +0.324* |   0.231 | weekly_flow |
| #14 | BBAND                  |  +0.368* |  +0.152* |   0.052 |    level |
| #15 | STOCH_RSI              |  +0.292* |  +0.107* |   0.040 |    level |
| #16 | MARKET_MOMENTUM        |  +0.233* |  +0.133* |   0.037 |    level |
...
|------|------|--------|------|---------|---------|------|
| #1 | Alphabet Inc. (Class A) | +68.0% [주의] |   250일 | 0.9239 | 0.0000 | 1.37 |
| #2 | Micron Technology | +702.1% [주의] |   250일 | 0.5287 | 0.0000 | 3.40 |
| #3 | Nvidia       | +17.4% [주의] |   250일 | 0.5045 | 0.0000 | 1.90 |
| #4 | Apple Inc.   | +35.6% [주의] |   250일 | 0.4468 | 0.0000 | 0.73 |
| #5 | Advanced Micro Devices | +187.6% [주의] |   250일 | 0.3018 | 0.0000 | 3.20 |
...
|------|------|-----------|------|---------|---------|
| #1 | Sandisk      | +3008.6% [주의] |   250일 | 14.3385 | 0.0000 |
| #2 | Micron Technology | +683.4% [주의] |   250일 | 3.6402 | 0.0000 |
| #3 | Lumentum     | +591.9% [주의] |   250일 | 2.3460 | 0.0000 |
| #4 | Western Digital | +448.3% [주의] |   250일 | 2.1910 | 0.0000 |
| #5 | Seagate Technology | +382.6% [주의] |   250일 | 1.6058 | 0.0000 |
...
| 순위 | 기업 | 수익률 | 기간 | 기여점수 | p-value | 베타 |
|------|------|--------|------|---------|---------|------|
| #1 | KB금융         | +54.0% [주의] |   243일 | 0.0090 | 0.0000 | 0.33 |
| #2 | GS           | +175.8% [주의] |   243일 | 0.0079 | 0.0000 | 0.35 |
| #3 | HD현대에너지솔루션   | +223.3% [주의] |   243일 | 0.0078 | 0.0000 | 0.74 |
| #4 | HD현대일렉트릭     | +43.1% [주의] |   243일 | 0.0073 | 0.0000 | 0.93 |
| #5 | DB하이텍        | +91.8% [주의] |   243일 | 0.0068 | 0.0000 | 1.05 |
...
| 순위 | 기업 | 초과수익률 | 기간 | 수혜점수 | p-value |
|------|------|-----------|------|---------|---------|
| #1 | HD현대에너지솔루션   | +110.4% [주의] |   243일 | 0.3722 | 0.0000 |
| #2 | GS           | +62.9% [주의] |   243일 | 0.2171 | 0.0000 |
...
|------|-----------------|-------|-----------|
| BBAND                  | 2026-08-25   |   257 |          1 |
| DXY                    | 2026-08-21   |   273 |          5 |
| FOREIGN_NET            | 2026-08-25   |   267 |          1 |
| HY_SPREAD              | 2026-08-24   |   288 |          2 |
| INSTITUTION_NET        | 2026-08-25   |   267 |          1 |
| MARKET_MOMENTUM        | 2026-08-25   |   257 |          1 |
| MARKET_STRENGTH        | 2026-08-25   |   262 |          1 |
| STOCH_RSI              | 2026-08-25   |   249 |          1 |
| T10Y2Y                 | 2026-08-25   |   275 |          1 |
| US10Y                  | 2026-08-24   |   274 |          2 |
| VIX                    | 2026-08-25   |   277 |          1 |
| WTI                    | 2026-08-18   |   269 |          8 |
...
> 생성 기준: 2026-08-26 01:57 | 모델: AI Analyzer v3 | 데이터: 최신 파이프라인 결과
...
**VIX (공포지수, w=0.4119)**: 현재 시장 변동성을 가장 정확하게 선행합니다. VIX 상승 = 주식 하락 압력 (r=-0.208). 30 초과 시 극도 공포 구간으로 역매수 기회.

**HY_SPREAD (하이일드스프레드, w=0.2999)**: 신용 리스크 선행 지표. 스프레드 확대 = 자금 이탈 시그널 (r=-0.621). 400bp 이하 유지 시 안정권.

**DXY (달러인덱스, w=0.2965)**: 글로벌 유동성의 역지표 (r=-0.376). 달러 강세 = 신흥국 자금 이탈, 원화 약세 → 코스피 압박.
