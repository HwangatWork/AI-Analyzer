...
**생성일시**: 2026-06-23 04:31
**분석 기간**: 2025-06-23 ~ 2026-06-23 (1년 (365일))
...
|------|------|---------|---------|--------|------|
| # 2 | HY_SPREAD              |  -0.631* |  -0.150* |   0.278 |     diff |
| # 4 | DXY                    |  -0.319* |  -0.192* |   0.251 |     diff |
| # 5 | WTI                    |  -0.350* |  -0.148* |   0.248 |     diff |
| # 6 | VIX                    |  -0.216* |  -0.094  |   0.243 |    level |
| # 7 | US10Y                  |  -0.236* |  -0.008  |   0.241 |     diff |
| # 8 | MARKET_STRENGTH        |  +0.211* |  +0.109* |   0.232 |    level |
| # 9 | FOREIGN_NET            |  +0.057  |  +0.269* |   0.227 | weekly_flow |
| #10 | CNN_FG                 |  +0.033  |  +0.044  |   0.200 |    level |
| #14 | INSTITUTION_NET        |  +0.095  |  +0.380* |   0.060 | weekly_flow |
| #16 | BBAND                  |  +0.367* |  +0.141* |   0.051 |    level |
| #18 | STOCH_RSI              |  +0.287* |  +0.126* |   0.041 |    level |
| #19 | MARKET_MOMENTUM        |  +0.234* |  +0.130* |   0.036 |    level |
...
|------|------|--------|------|---------|---------|------|
| #1 | Alphabet Inc. (Class C) | +110.7% [주의] |   250일 | 1.2529 | 0.0000 | 1.30 |
| #2 | Nvidia       | +44.9% [주의] |   250일 | 1.0244 | 0.0000 | 1.85 |
| #3 | Micron Technology | +894.7% [주의] |   250일 | 0.7009 | 0.0000 | 3.04 |
| #4 | Apple Inc.   | +48.0% [주의] |   250일 | 0.6953 | 0.0000 | 0.89 |
| #5 | Advanced Micro Devices | +325.7% [주의] |   250일 | 0.3885 | 0.0000 | 2.90 |
...
|------|------|-----------|------|---------|---------|
| #1 | Sandisk      | +4718.9% [주의] |   250일 | 22.2430 | 0.0000 |
| #2 | Western Digital | +1092.6% [주의] |   250일 | 5.4628 | 0.0000 |
| #3 | Micron Technology | +870.6% [주의] |   250일 | 4.6289 | 0.0000 |
| #4 | Lumentum     | +878.6% [주의] |   250일 | 3.2951 | 0.0000 |
| #5 | Seagate Technology | +708.7% [주의] |   250일 | 3.0860 | 0.0000 |
...
| 순위 | 기업 | 수익률 | 기간 | 기여점수 | p-value | 베타 |
|------|------|--------|------|---------|---------|------|
| #1 | HD현대일렉트릭     | +109.7% [주의] |   244일 | 0.0165 | 0.0000 | 0.99 |
| #2 | DB하이텍        | +242.6% [주의] |   244일 | 0.0157 | 0.0000 | 1.06 |
| #3 | KB금융         | +44.9% [주의] |   244일 | 0.0091 | 0.0000 | 0.52 |
| #4 | HD현대중공업      | +39.6% [주의] |   244일 | 0.0075 | 0.0000 | 0.61 |
| #5 | HJ중공업        | +172.7% [주의] |   244일 | 0.0071 | 0.0000 | 0.83 |
...
| 순위 | 기업 | 초과수익률 | 기간 | 수혜점수 | p-value |
|------|------|-----------|------|---------|---------|
| #1 | DB하이텍        | +52.6% [주의] |   244일 | 0.2955 | 0.0000 |
...
|------|-----------------|-------|-----------|
| BBAND                  | 2026-06-22   |   255 |          1 |
| CNN_FG                 | 2026-06-23   |   400 |          0 |
| DXY                    | 2026-06-18   |   272 |          5 |
| FOREIGN_NET            | 2026-06-22   |   267 |          1 |
| HY_SPREAD              | 2026-06-19   |   289 |          4 |
| INSTITUTION_NET        | 2026-06-22   |   267 |          1 |
| MARKET_MOMENTUM        | 2026-06-22   |   255 |          1 |
| MARKET_STRENGTH        | 2026-06-22   |   260 |          1 |
| STOCH_RSI              | 2026-06-22   |   247 |          1 |
| US10Y                  | 2026-06-18   |   272 |          5 |
| VIX                    | 2026-06-22   |   275 |          1 |
| WTI                    | 2026-06-15   |   268 |          8 |
...
> 생성 기준: 2026-06-23 04:31 | 모델: AI Analyzer v3 | 데이터: 최신 파이프라인 결과

### 현재 시장 판단: 41.1/100 — **HOLD·중립**
...
**DXY (달러인덱스, w=0.2510)**: 글로벌 유동성의 역지표 (r=-0.319). 달러 강세 = 신흥국 자금 이탈, 원화 약세 → 코스피 압박.
