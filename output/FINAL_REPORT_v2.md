...
**생성일시**: 2026-08-25 01:55
**분석 기간**: 2025-08-25 ~ 2026-08-25 (1년 (365일))
...
|------|------|---------|---------|--------|------|
| # 1 | VIX                    |  -0.207* |  -0.083  |   0.412 |    level |
| # 3 | HY_SPREAD              |  -0.622* |  -0.112* |   0.300 |     diff |
| # 4 | DXY                    |  -0.375* |  -0.137* |   0.296 |     diff |
| # 6 | INSTITUTION_NET        |  +0.069  |  +0.355* |   0.261 | weekly_flow |
| # 7 | US10Y                  |  -0.245* |  +0.011  |   0.243 |     diff |
| # 9 | MARKET_STRENGTH        |  +0.209* |  +0.125* |   0.233 |    level |
| #10 | FOREIGN_NET            |  +0.056  |  +0.327* |   0.232 | weekly_flow |
| #15 | BBAND                  |  +0.365* |  +0.151* |   0.052 |    level |
| #16 | STOCH_RSI              |  +0.294* |  +0.108* |   0.040 |    level |
| #17 | MARKET_MOMENTUM        |  +0.232* |  +0.132* |   0.036 |    level |
| #18 | WTI                    |  -0.346* |  -0.095  |   0.035 |     diff |
| #22 | T10Y2Y                 |  -0.091  |  -0.099* |   0.010 |     diff |
...
|------|------|--------|------|---------|---------|------|
| #1 | Alphabet Inc. (Class A) | +67.4% [주의] |   250일 | 0.9212 | 0.0000 | 1.36 |
| #2 | Micron Technology | +683.3% [주의] |   250일 | 0.5135 | 0.0000 | 3.39 |
| #3 | Nvidia       | +16.1% [주의] |   250일 | 0.4630 | 0.0000 | 1.90 |
| #4 | Apple Inc.   | +37.1% [주의] |   250일 | 0.4621 | 0.0000 | 0.74 |
| #5 | Advanced Micro Devices | +179.6% [주의] |   250일 | 0.2836 | 0.0000 | 3.20 |
...
|------|------|-----------|------|---------|---------|
| #1 | Sandisk      | +3072.9% [주의] |   250일 | 14.6556 | 0.0000 |
| #2 | Micron Technology | +664.4% [주의] |   250일 | 3.5347 | 0.0000 |
| #3 | Lumentum     | +553.8% [주의] |   250일 | 2.1922 | 0.0000 |
| #4 | Western Digital | +432.2% [주의] |   250일 | 2.1102 | 0.0000 |
| #5 | Seagate Technology | +369.7% [주의] |   250일 | 1.5497 | 0.0000 |
...
| 순위 | 기업 | 수익률 | 기간 | 기여점수 | p-value | 베타 |
|------|------|--------|------|---------|---------|------|
| #1 | KB금융         | +50.1% [주의] |   243일 | 0.0084 | 0.0000 | 0.32 |
| #2 | GS           | +163.4% [주의] |   243일 | 0.0073 | 0.0000 | 0.34 |
| #3 | DB하이텍        | +98.4% [주의] |   243일 | 0.0071 | 0.0000 | 1.04 |
| #4 | HD현대에너지솔루션   | +201.7% [주의] |   243일 | 0.0070 | 0.0000 | 0.74 |
| #5 | HD현대일렉트릭     | +39.2% [주의] |   243일 | 0.0065 | 0.0000 | 0.93 |
...
| 순위 | 기업 | 초과수익률 | 기간 | 수혜점수 | p-value |
|------|------|-----------|------|---------|---------|
| #1 | HD현대에너지솔루션   | +99.7% [주의] |   243일 | 0.3339 | 0.0000 |
| #2 | GS           | +61.3% [주의] |   243일 | 0.2107 | 0.0000 |
...
|------|-----------------|-------|-----------|
| BBAND                  | 2026-08-24   |   257 |          1 |
| DXY                    | 2026-08-21   |   274 |          4 |
| FOREIGN_NET            | 2026-08-24   |   267 |          1 |
| HY_SPREAD              | 2026-08-21   |   288 |          4 |
| INSTITUTION_NET        | 2026-08-24   |   267 |          1 |
| MARKET_MOMENTUM        | 2026-08-24   |   257 |          1 |
| MARKET_STRENGTH        | 2026-08-24   |   262 |          1 |
| STOCH_RSI              | 2026-08-24   |   249 |          1 |
| T10Y2Y                 | 2026-08-24   |   275 |          1 |
| US10Y                  | 2026-08-21   |   274 |          4 |
| VIX                    | 2026-08-24   |   277 |          1 |
| WTI                    | 2026-08-18   |   270 |          7 |
...
> 생성 기준: 2026-08-25 01:55 | 모델: AI Analyzer v3 | 데이터: 최신 파이프라인 결과

### 현재 시장 판단: 44.8/100 — **HOLD·중립**
...
**VIX (공포지수, w=0.4118)**: 현재 시장 변동성을 가장 정확하게 선행합니다. VIX 상승 = 주식 하락 압력 (r=-0.207). 30 초과 시 극도 공포 구간으로 역매수 기회.

**HY_SPREAD (하이일드스프레드, w=0.3003)**: 신용 리스크 선행 지표. 스프레드 확대 = 자금 이탈 시그널 (r=-0.622). 400bp 이하 유지 시 안정권.

**DXY (달러인덱스, w=0.2963)**: 글로벌 유동성의 역지표 (r=-0.375). 달러 강세 = 신흥국 자금 이탈, 원화 약세 → 코스피 압박.
