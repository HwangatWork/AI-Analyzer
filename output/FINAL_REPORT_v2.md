...
**생성일시**: 2026-08-18 01:48
**분석 기간**: 2025-08-18 ~ 2026-08-18 (1년 (365일))
...
| # 2 | DXY                    |  -0.376* |  -0.150* |   0.295 |     diff |
| # 4 | INSTITUTION_NET        |  +0.066  |  +0.358* |   0.259 | weekly_flow |
| # 5 | US10Y                  |  -0.245* |  -0.006  |   0.239 |     diff |
| # 6 | MARKET_STRENGTH        |  +0.218* |  +0.133* |   0.235 |    level |
| # 8 | FOREIGN_NET            |  +0.057  |  +0.326* |   0.232 | weekly_flow |
| #10 | VIX                    |  -0.212* |  -0.089  |   0.221 |    level |
| #13 | BBAND                  |  +0.370* |  +0.152* |   0.052 |    level |
| #15 | STOCH_RSI              |  +0.298* |  +0.116* |   0.041 |    level |
| #16 | MARKET_MOMENTUM        |  +0.234* |  +0.134* |   0.037 |    level |
| #18 | WTI                    |  -0.341* |  -0.093  |   0.034 |     diff |
| #21 | T10Y2Y                 |  -0.091  |  -0.135* |   0.013 |     diff |
...
|------|------|--------|------|---------|---------|------|
| #1 | Alphabet Inc. (Class A) | +69.5% [주의] |   250일 | 0.9337 | 0.0000 | 1.37 |
| #2 | Nvidia       | +23.8% [주의] |   250일 | 0.6936 | 0.0000 | 1.89 |
| #3 | Micron Technology | +720.2% [주의] |   250일 | 0.5746 | 0.0000 | 3.37 |
| #4 | Apple Inc.   | +32.8% [주의] |   250일 | 0.4230 | 0.0000 | 0.74 |
| #5 | Advanced Micro Devices | +187.3% [주의] |   250일 | 0.3198 | 0.0000 | 3.20 |
...
|------|------|-----------|------|---------|---------|
| #1 | Sandisk      | +3805.3% [주의] |   250일 | 18.0522 | 0.0000 |
| #2 | Micron Technology | +700.1% [주의] |   250일 | 3.7412 | 0.0000 |
| #3 | Western Digital | +584.4% [주의] |   250일 | 2.8699 | 0.0000 |
| #4 | Lumentum     | +694.2% [주의] |   250일 | 2.7565 | 0.0000 |
| #5 | Seagate Technology | +511.9% [주의] |   250일 | 2.1628 | 0.0000 |
...
| 순위 | 기업 | 수익률 | 기간 | 기여점수 | p-value | 베타 |
|------|------|--------|------|---------|---------|------|
| #1 | HD현대일렉트릭     | +74.3% [주의] |   243일 | 0.0119 | 0.0000 | 0.95 |
| #2 | KB금융         | +55.8% [주의] |   243일 | 0.0095 | 0.0000 | 0.34 |
| #3 | DB하이텍        | +119.0% [주의] |   243일 | 0.0088 | 0.0000 | 1.05 |
| #4 | GS           | +169.4% [주의] |   243일 | 0.0080 | 0.0000 | 0.37 |
| #5 | HD현대         | +78.9% [주의] |   243일 | 0.0066 | 0.0000 | 0.52 |
...
| 순위 | 기업 | 초과수익률 | 기간 | 수혜점수 | p-value |
|------|------|-----------|------|---------|---------|
| #1 | GS           | +44.1% [주의] |   243일 | 0.1608 | 0.0000 |
| #2 | HD현대에너지솔루션   | +43.2% [주의] |   243일 | 0.1482 | 0.0000 |
| #3 | DN오토모티브      | +47.1% [주의] |   243일 | 0.1439 | 0.0000 |
...
|------|-----------------|-------|-----------|
| BBAND                  | 2026-08-17   |   257 |          1 |
| DXY                    | 2026-08-14   |   274 |          4 |
| FOREIGN_NET            | 2026-08-14   |   267 |          4 |
| HY_SPREAD              | 2026-08-14   |   288 |          4 |
| INSTITUTION_NET        | 2026-08-14   |   267 |          4 |
| MARKET_MOMENTUM        | 2026-08-17   |   257 |          1 |
| MARKET_STRENGTH        | 2026-08-17   |   262 |          1 |
| STOCH_RSI              | 2026-08-17   |   249 |          1 |
| T10Y2Y                 | 2026-08-17   |   275 |          1 |
| US10Y                  | 2026-08-14   |   274 |          4 |
| VIX                    | 2026-08-17   |   277 |          1 |
| WTI                    | 2026-08-11   |   270 |          7 |
...
> 생성 기준: 2026-08-18 01:48 | 모델: AI Analyzer v3 | 데이터: 최신 파이프라인 결과

### 현재 시장 판단: 60.4/100 — **BUY 우위**
...
**DXY (달러인덱스, w=0.2949)**: 글로벌 유동성의 역지표 (r=-0.376). 달러 강세 = 신흥국 자금 이탈, 원화 약세 → 코스피 압박.
